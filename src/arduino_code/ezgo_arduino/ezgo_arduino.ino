...
void showInfo()
{
    ...
    writer_buf[3] = ((byte) mode) & 0x1;
    float current_vel = vel;
    writer_buf[4] = ((byte) current_vel) & 0xff;
    writer_buf[5] = (((byte) current_vel) >> 8) & 0xff;
    writer_buf[6] = (((byte) current_vel) >> 16) & 0xff;
    writer_buf[7] = (((byte) current_vel) >> 24) & 0xff;
